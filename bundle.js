...
var WhiteBoard = React.createClass({displayName: "WhiteBoard",
	render: function() {
		...
		var boardList = this.props.data.map(function(option) {
				return React.createElement("ul", {key: option.name}, option.name, " the ", option.value)
		})

		return (
		      React.createElement("ol", {className: "boardList col-md-6 col-md-offset-3"}, 
		        boardList
		      )
		)
	}
...
var data = [{name: "france", value: "pug"}, {name: "britain", value: "terrier"}];


var WhiteBoardApp = React.createClass({displayName: "WhiteBoardApp",
	render: function() {
		return (
			React.createElement(WhiteBoard, {data: this.props.data})
			)
	}
});

React.render(
	React.createElement(WhiteBoardApp, {data: data}),
	document.getElementById("content")
);

},{"./components/WhiteBoard.js":147,"react":146}],149:[function(require,module,exports){
